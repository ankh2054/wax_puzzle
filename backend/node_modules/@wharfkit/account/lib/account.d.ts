...
declare class Resource {
    ...
    toJSON(): {
        resource: ResourceType;
        available: Int64;
        current_used: Int64 | undefined;
        used: Int64;
        max: Int64;
        weight: Int64 | undefined;
    };
}
...
export { Account, AccountArgs, AccountKit, ActionData, AddKeyActionParam, BuyramOptions, DelegateOptions, LinkedAction, LinkedActionType, Permission, PermissionData, PermissionType, Resource, ResourceType, ResourceValues, eosio as SystemContract, UndelegateOptions, WaitWeightType };
